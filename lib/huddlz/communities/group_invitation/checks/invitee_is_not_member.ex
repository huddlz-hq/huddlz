defmodule Huddlz.Communities.GroupInvitation.Checks.InviteeIsNotMember do
  ...
  def validate(changeset, _opts, _context) do
    ...
    invitee_id = Ash.Changeset.get_attribute(changeset, :invitee_id)

    invitee_ids = List.wrap(invitee_id)

    GroupMember
    |> Ash.Query.filter(group_id == ^group_id and user_id in ^invitee_ids)
