defmodule HuddlzWeb.Components.HuddlForm do
  ...
  attr :modal_location_time_zone, :string, default: nil
  attr :modal_location_time_zone_error, :string, default: nil
