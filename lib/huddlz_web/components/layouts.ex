  ...
  def app(assigns) do
    ...
    <header class="navbar bg-base-100 px-4 sm:px-6 lg:px-8 shadow">
      ...
      <div class="navbar-end flex items-center gap-4">
        ...
        <% end %>
        <a href="https://github.com/huddlz-hq/huddlz" class="text-gray-900" title="Contribute on GitHub">
          <svg xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 0 16 16" width="20" aria-hidden="true" class="size-5">
