...
| Keyboard focus | The skip link is the first Tab stop on app, auth and landing pages and focuses the main content landmark; failed saves focus their invalid fields, including registration's agreement, group location pickers, address creation, invitations, turnout and social schedules; a clean save leaves focus on the button |
