...
| Keyboard focus | The skip link is the first Tab stop on app, auth and landing pages and moves focus into the page content; a failed save focuses the first invalid field, which names its error; a clean save leaves focus on the button |
