...
**Administrator**:
A trusted member of the huddlz staff responsible for platform and account administration. This role is distinct from a group's owner, organizer, or member roles.
...
**Account report**:
A confirmed member's request for administrators to review an account they can already see, for spam or another concern. A report does not itself suspend the account; its details and the reporter's identity are available only to trusted huddlz staff for review.
